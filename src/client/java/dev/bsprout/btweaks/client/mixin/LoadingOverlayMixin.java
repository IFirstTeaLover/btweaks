        ...
        if (progressWidth > 0) {
            if (isJune()) {
                ...
                for (int x = 0; x < progressWidth; x++) {
                    ...
                    RoundRect.draw(canvas, i + 2 + x, j + 2, 5, l - j - 4, color, 2);
                }
            } else {
                // non-gay bar
                RoundRect.draw(canvas, i + 2, j + 2, progressWidth, (l - j) - 4, color, 2);
            }
        }
    }
